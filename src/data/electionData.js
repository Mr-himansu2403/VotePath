export const INITIAL_STEPS = [
  {
    ...
    tag: "official", tagLabel: "Official",
    emoji: "📣",
    title: "Election Announcement & Schedule",
    subtitle: "The Election Commission of India formally announces election dates, marking the start of the entire electoral process.",
    sections: [
      ...
      { title: "Key Actions by Citizens", items: [
  ...
  },
  {
    ...
    tag: "civic", tagLabel: "Civic",
    emoji: "📝",
    title: "Voter Registration",
    subtitle: "Every eligible citizen aged 18+ must be registered. Registration typically closes before the announcement, but this is the foundation.",
    sections: [
      ...
      { title: "Eligibility Criteria", items: [
  ...
  },
  {
    ...
    subtitle: "A set of guidelines issued by ECI to ensure free and fair elections. Binding on all parties, candidates, and the government.",
    sections: [
      { title: "MCC Prohibitions", items: [
  ...
  },
  {
    ...
    subtitle: "Candidates officially declare their intent to contest by filing nomination papers before the Returning Officer.",
    sections: [
      { title: "Nomination Requirements", items: [
      ...
      { title: "Eligibility to Contest", items: [
  ...
  },
  {
    ...
    subtitle: "The Returning Officer examines all nomination papers for completeness and legal validity. Defective nominations may be rejected.",
    sections: [
      { title: "Scrutiny Checks", items: [
  ...
  },
  {
    ...
    subtitle: "Candidates who change their mind may withdraw within a specified period. After this, the final list of contestants is prepared.",
    sections: [
      { title: "Withdrawal Process", items: [
  ...
  },
  {
    ...
    subtitle: "Candidates and parties campaign to persuade voters. This is the most visible phase, governed strictly by the Model Code of Conduct.",
    sections: [
      { title: "Permitted Campaign Activities", items: [
      ...
      { title: "Campaign Spending Limits", items: [
  ...
  },
  {
    ...
    tag: "key", tagLabel: "Key",
    emoji: "🗳️",
    title: "Polling Day — Casting Your Vote",
    subtitle: "The most important day of democracy! Eligible voters cast their vote using Electronic Voting Machines (EVMs) at their designated polling booths.",
    sections: [
      { title: "How to Vote (Step by Step)", items: [
      ...
      { title: "Voter Rights on Polling Day", items: [
  ...
  },
  {
    ...
    subtitle: "All EVMs are transported to counting centres under heavy security. Counting happens in rounds, observed by agents of each candidate.",
    sections: [
      { title: "Counting Process", items: [
  ...
  },
  {
    ...
    subtitle: "The winning candidate is declared, receives their certificate, and ultimately a new government is formed through the constitutional process.",
    sections: [
      { title: "After Results", items: [
      ...
      { title: "Election Petitions", items: [
...
export const INITIAL_QUIZ = [
  { q: "What is the minimum age to vote in India?", opts: ["16 years", "18 years", "21 years", "25 years"], ans: 1, exp: "The 61st Amendment (1988) lowered the voting age from 21 to 18 years, allowing millions of young citizens to participate in democracy." },
  { q: "NOTA stands for:", opts: ["No Option To Abstain", "None of the Above", "National Obligation To Abstain", "Not On The Agenda"], ans: 1, exp: "NOTA (None of the Above) was introduced in 2013 by the Supreme Court order, allowing voters to reject all candidates without abstaining." },
  { q: "What does VVPAT stand for?", opts: ["Voter Verified Paper Audit Trail", "Vote Verification and Polling Audit Terminal", "Verified Voting Paper Audit Technology", "Voter Verified Public Audit Trail"], ans: 0, exp: "VVPAT is a paper receipt printed by the EVM showing the voter which candidate their vote was cast for. It is visible for 7 seconds." },
  { q: "The Model Code of Conduct comes into effect:", opts: ["One week before polling", "On the day of polling", "Immediately when ECI announces the election schedule", "After nominations close"], ans: 2, exp: "The MCC becomes effective the moment ECI announces the election schedule, placing restrictions on governments and candidates." },
  { q: "What is the security deposit for a Lok Sabha candidate (General category)?", opts: ["₹10,000", "₹25,000", "₹50,000", "₹1,00,000"], ans: 1, exp: "A General category candidate must deposit ₹25,000 (₹12,500 for SC/ST candidates) while filing nominations. This is forfeited if they get less than 1/6 of valid votes." },
  { q: "Which app can citizens use to report election MCC violations?", opts: ["UMANG App", "DigiLocker", "C-Vigil App", "Aarogya Setu"], ans: 2, exp: "The C-Vigil App by ECI allows citizens to report MCC violations with photo/video evidence. Teams respond within 100 minutes." },
  { q: "How many Lok Sabha seats are needed for a majority?", opts: ["250", "272", "300", "321"], ans: 1, exp: "The Lok Sabha has 543 seats. A party/alliance needs 272 seats (simple majority = 50% + 1) to form a government independently." },
  { q: "EVMs were first used in all constituencies in which Indian General Election?", opts: ["1999", "2004", "2009", "2014"], ans: 1, exp: "Electronic Voting Machines were used across all constituencies in India for the first time in the 2004 General Elections (14th Lok Sabha)." }
];

export const INITIAL_GLOSSARY = [
  { term: "ECI", def: "Election Commission of India — the independent constitutional body responsible for conducting elections across India.", badge: "tag-official", badgeLabel: "Regulatory" },
  { term: "EPIC", def: "Elector's Photo Identity Card — commonly known as the Voter ID card, issued by ECI for voter identification.", badge: "tag-civic", badgeLabel: "Civic" },
  { term: "MCC", def: "Model Code of Conduct — guidelines issued by ECI to ensure free and fair elections, binding from announcement to results.", badge: "tag-legal", badgeLabel: "Legal" },
  { term: "EVM", def: "Electronic Voting Machine — an electronic device used in India to record votes. It consists of a Control Unit and a Balloting Unit.", badge: "tag-key", badgeLabel: "Technology" },
  { term: "VVPAT", def: "Voter Verified Paper Audit Trail — a printer attached to the EVM that produces a paper slip confirming the vote cast, visible for 7 seconds.", badge: "tag-key", badgeLabel: "Technology" },
  { term: "NOTA", def: "None of the Above — an option on the EVM allowing voters to reject all candidates without abstaining from voting.", badge: "tag-civic", badgeLabel: "Voter Right" },
  { term: "Returning Officer", def: "A government officer appointed by ECI to oversee elections in a constituency, from accepting nominations to declaring results.", badge: "tag-official", badgeLabel: "Official" },
  { term: "Constituency", def: "A defined geographical area from which voters elect a representative to the Lok Sabha or state legislature.", badge: "tag-official", badgeLabel: "Geography" },
  { term: "Affidavit", def: "A sworn statement by candidates declaring criminal antecedents, assets, liabilities, and educational qualifications.", badge: "tag-legal", badgeLabel: "Legal" },
  { term: "Postal Ballot", def: "A system allowing certain categories of voters (armed forces, overseas electors, police, etc.) to vote by post.", badge: "tag-civic", badgeLabel: "Mechanism" },
  { term: "ETPBS", def: "Electronically Transmitted Postal Ballot System — allows service voters to receive and return ballots electronically.", badge: "tag-key", badgeLabel: "Technology" },
  { term: "C-Vigil App", def: "A mobile app by ECI allowing citizens to report MCC violations with photo/video evidence. Response time is 100 minutes.", badge: "tag-official", badgeLabel: "Tool" },
  { term: "Observer", def: "An IAS/IPS officer appointed by ECI to an independent observer of election activities and expenditure in a constituency.", badge: "tag-official", badgeLabel: "Watchdog" },
  { term: "NOTA", def: "None of the Above — introduced in 2013 via Supreme Court order, it lets voters express disapproval of all candidates.", badge: "tag-civic", badgeLabel: "Right" },
